      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">Discover unique treasures at our auctions. We specialize in rare and valuable items.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm">Email: info@auctionhouse.com</p>
