...
const AuctionRooms = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-gradient-to-br from-[#020141] via-purple-900 to-indigo-900 text-white'>
      <style jsx>{`
      ...
      <footer className='h-20 w-full'>
        <div className='h-full w-full glass-effect rounded-t-2xl flex items-center justify-between px-6'>
          <div className="text-lg font-bold text-yellow-300">BIỂN HOT NGÀY 19/09/2024</div>
          <div className="bg-white text-black px-4 py-2 rounded-full font-bold text-xl">
            20A 777.73
          </div>
          <div className="text-lg font-bold text-pink-300">Đăng ký đấu giá ngay tại VPA.COM.VN</div>
        </div>
      </footer>
    </div>
  )
